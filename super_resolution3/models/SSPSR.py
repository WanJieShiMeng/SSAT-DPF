...
from super_resolution3.models.common import *
...
class SSPSR(nn.Module):
    ...
    def forward(self, x, lms):  #  lms = torch.rand(2,128,64,64).to(torch.device('cuda'))
        b, c, h, w = x.shape
...
if __name__ == '__main__':
    ...
    net = SSPSR().to(device)
    print(summary(net,(128,16,16),batch_size=10))
